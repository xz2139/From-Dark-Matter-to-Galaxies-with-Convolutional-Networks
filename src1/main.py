...
def parse_args():
    ...
    parser.add_argument('--regression', type = int, default= False,
    ...
    parser.add_argument('--load_model', type=int, default=,
    ...
    parser.add_argument('--record_results', type=bool, default=False,
    ...
    parser.add_argument('--dark_matter_mean', type=float, default=5.614541,
                        help='whether to normalize the input(dark matter density)')
    parser.add_argument('--phase_2', default="",
