...
state_dict = torch.load('Test11_1109_filter16/checkpoint_1030_all.pth')
...
np.save('/scratch/xz2139/predictions_test11.npy',predictions)
data_range = 1024
...
dark=np.load('/scratch/xz2139/cosmo_dark/Dark_zeros.npy')
pred=np.load('/scratch/xz2139/predictions_test11.npy')
...
for i in range(80,960,60):
    ...
    fig.savefig('axis_'+str(i)+'_pred.png')   # save the figure to file
    plt.close(fig) 